					...
					<div class="tab-content">
						...
						<div class="tab-pane container-fluid <?php if(isset($_POST['add_image']) || isset($_POST['delete_image'])): ?>active<?php endif; ?>" id="images" role="tabpanel">
							...
							<div class="row">
								...
								<?php $query = $db->query('SELECT * FROM image ORDER BY id DESC'); ?>

								
								<?php  while($image = $query->fetch()):?>
								<form action="article-form.php?article_id=<?php echo $article['id']; ?>&action=edit" method="post" class="col-4 my-3">
									<img src="../img/article/<?php echo $image['name']; ?>" alt="" class="img-fluid" />
